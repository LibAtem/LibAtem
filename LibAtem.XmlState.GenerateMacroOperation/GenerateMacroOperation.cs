...
//                return CastExpression(ParseTypeName("System.UInt32"), expr);
        ...
        private static string GenerateClass(List<Operation> operations, List<Field> fields)
        {
            ...
            newNamespace = newNamespace.WithNamespaceKeyword(SyntaxFactory.Token(
                SyntaxFactory.TriviaList(
                    new[]
                    {
                        SyntaxFactory.Comment("// Warning: This is an autogenerated class"),
                        SyntaxFactory.Comment("// This is generated from the MacroOp classes which have are decorated with MacroOperationAttribute"),
                        SyntaxFactory.Comment("// To regenerate this file, run LibAtem.XmlState.GenerateMacroOperation")
                    }),
